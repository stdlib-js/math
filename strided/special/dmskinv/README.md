...
-   [`@stdlib/math/strided/special/smskinv`][@stdlib/math/strided/special/smskinv]: compute the multiplicative inverse for each element in a single-precision floating-point strided array according to a strided mask array.
