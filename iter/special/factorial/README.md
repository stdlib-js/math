...
-   [`@stdlib/math/iter/special/factorialln`][@stdlib/math/iter/special/factorialln]: create an iterator which evaluates the natural logarithm of the factorial function for each iterated value.
