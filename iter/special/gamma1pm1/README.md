...
> Create an [iterator][mdn-iterator-protocol] which computes [`gamma(x+1) - 1`][@stdlib/math/base/special/gamma1pm1] for each iterated value.
...
Returns an [iterator][mdn-iterator-protocol] which iteratively computes [`gamma(x+1) - 1`][@stdlib/math/base/special/gamma1pm1] without cancellation errors for small `x`.
