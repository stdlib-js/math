...
var hacoversin = require( './../../../../base/special/hacoversin' );
...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof iterHacoversin, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function returns an iterator protocol-compliant object which returns `NaN` if provided a non-numeric value', function test( t ) {
	...
	it = iterHacoversin( array2iterator( values ) );
	t.strictEqual( it.next.length, 0, 'has zero arity' );
