...
-   [`@stdlib/math/iter/special/log1pexp`][@stdlib/math/iter/special/log1pexp]: create an iterator which evaluates the natural logarithm of 1+exp(x) for each iterated value.
