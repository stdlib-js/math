...
> Create an [iterator][mdn-iterator-protocol] which [rounds][@stdlib/math/base/special/floor] each iterated value toward negative infinity.
...
Returns an [iterator][mdn-iterator-protocol] which [rounds][@stdlib/math/base/special/floor] each iterated value toward negative infinity.

```javascript
var array2iterator = require( '@stdlib/array/to-iterator' );

var it = iterFloor( array2iterator( [ 2.5, -1.5, 10.3 ] ) );
// returns <Object>
