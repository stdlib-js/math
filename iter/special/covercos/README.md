...
> Create an [iterator][mdn-iterator-protocol] which computes the [coversed cosine][@stdlib/math/base/special/covercos] for each iterated value.
...
Returns an [iterator][mdn-iterator-protocol] which iteratively computes the [coversed cosine][@stdlib/math/base/special/covercos].

```javascript
var array2iterator = require( '@stdlib/array/to-iterator' );

var it = iterCovercos( array2iterator( [ 0.0, 1.57 ] ) );
// returns <Object>
