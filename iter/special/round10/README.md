...
-   [`@stdlib/math/iter/special/trunc10`][@stdlib/math/iter/special/trunc10]: create an iterator which rounds each iterated value to the nearest power of 10 toward zero.
