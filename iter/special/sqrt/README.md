...
-   [`@stdlib/math/iter/special/cbrt`][@stdlib/math/iter/special/cbrt]: create an iterator which computes the cube root of each iterated value.
-   [`@stdlib/math/iter/special/rsqrt`][@stdlib/math/iter/special/rsqrt]: create an iterator which computes the reciprocal (inverse) square root of each iterated value.
