...
```javascript
import math from 'https://cdn.jsdelivr.net/gh/stdlib-js/math@v0.3.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { base, iter, special, strided, tools } from 'https://cdn.jsdelivr.net/gh/stdlib-js/math@v0.3.0-deno/mod.js';
```
