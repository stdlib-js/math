...
tape( 'sn export is a function', function test( t ) {
	...
	t.equal( typeof sn, 'function', 'sn export is a function' );
	t.end();
});

tape( 'cn export is a function', function test( t ) {
	t.ok( true, __filename );
	t.equal( typeof cn, 'function', 'cn export is a function' );
	t.end();
});

tape( 'dn export is a function', function test( t ) {
	t.ok( true, __filename );
	t.equal( typeof dn, 'function', 'dn export is a function' );
	t.end();
});

tape( 'am export is a function', function test( t ) {
	t.ok( true, __filename );
	t.equal( typeof am, 'function', 'am export is a function' );
	t.end();
});
