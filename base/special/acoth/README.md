...
<!-- <div class="equation" align="center" data-raw-text="y = \operatorname{arccoth}(x) = \frac{1}{2} \ln\left(\frac{x+1}{x-1}\right)" data-equation="eq:hyperbolic_arccotangent">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@85f48534ef6908bbcd982d48f1c5fbea3fb7aafd/lib/node_modules/@stdlib/math/base/special/acoth/docs/img/equation_hyperbolic_arccotangent.svg" alt="Hyperbolic arccotangent function">
    <br>
</div> -->
