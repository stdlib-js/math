...
<!-- <div class="equation" align="center" data-raw-text="y = \operatorname{arccsch}(x) = \ln\left(\frac{1}{x} + \frac{\sqrt{1 + x^2}}{|x|}\right)" data-equation="eq:hyperbolic_arccosecant">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@85f48534ef6908bbcd982d48f1c5fbea3fb7aafd/lib/node_modules/@stdlib/math/base/special/acsch/docs/img/equation_hyperbolic_arccosecant.svg" alt="Hyperbolic arccosecant function">
    <br>
</div> -->
