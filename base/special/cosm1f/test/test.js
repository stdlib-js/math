...
tape( 'the function computes the cosine minus one inside the interval [-π/4,π/4]', function test( t ) {
	var expected;
	var x;
	var y;
	var i;
...
tape( 'the function computes the cosine minus one for `x < -π/4`', function test( t ) {
	var expected;
	var x;
	var y;
	var i;
