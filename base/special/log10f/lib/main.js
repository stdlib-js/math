...
var kernelLog1pf = require( './../../../../base/special/kernel-log1pf' );
...
function log10f( x ) {
	...
	return f32( f32( f32( f32( f32( y*LOG10_2LO ) + f32( f32( lo+hi )*IVLN10LO ) ) + f32( lo*IVLN10HI ) ) + f32( hi*IVLN10HI ) ) + f32( y*LOG10_2HI ) ); // eslint-disable-line max-len
}
